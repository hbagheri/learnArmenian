...
- [✅] **8f. Voice recording integration** — 2026-06-06: Integrated voice recording/pronunciation scoring into lesson PRACTICE_PHRASE steps. Added SpeechRecorder + PronunciationScorer to ViewModel. Mic permission handling via Compose permission launcher. Phase state: Idle/Recording/Scoring. RecordingButton → mic permission request if needed → start/stop recording. Score results show with feedback. Continue button enabled only after successful recording. Full lifecycle integrated into step progression. Build successful ✅.
- [ ] 7. SRS + streak
