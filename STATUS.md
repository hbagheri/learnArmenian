...
- [🟡] **8e. Quiz step rendering** — 2026-06-06: Implemented QUIZ_LETTER and QUIZ_PHRASE step types. Each shows the letter/phrase card + 4 answer buttons (1 correct option + 3 random wrong answers). QuizAnswerButton composable with color feedback (green=correct, red=incorrect). "تأیید و ادامه" button disabled until correct answer selected. Persian feedback messages (✓ درست! / ✗ غلط، دوباره امتحان کنید). PRACTICE_PHRASE still pending.
- [ ] 7. SRS + streak
